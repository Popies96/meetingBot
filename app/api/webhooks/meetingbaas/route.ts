import { processMeetingTranscript } from "@/lib/gimini-processor";
        ...
        try {
          ...
          try {
            await sendMeetingSummaryEmail({
              ...
              userFirstName: meeting.user.firstName || "User firstame",
              userLastName: meeting.user.LastName || "User lastname",
