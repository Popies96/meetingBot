  ...
  return (
    <footer className="w-full bg-black/90">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-30 py-10 max-w-4xl mx-auto">
          <div className="text-center lg:text-left">
            <a href="#" className="flex justify-center lg:justify-start items-center gap-2 mb-6">
              <Bot className="w-8 h-8 text-indigo-400" />
              <span className="text-2xl font-bold text-white">Meeting Bot</span>
            </a>
            ...
            <a href="#" className="py-2.5 px-5 h-9 inline-block w-fit bg-indigo-500 rounded-full shadow-sm text-xs text-white transition-all duration-500 hover:bg-indigo-600">
              Contact us
            </a>
          </div>
          <div className="text-center lg:text-left">
        ...
        <div className="py-7 border-t border-gray-800">
          <div className="flex items-center justify-center">
            <span className="text-sm text-gray-400">&copy; {new Date().getFullYear()} MeetingBot. Made with ❤️ for better meetings.</span>
          </div>
        </div>
      </div>
    </footer>
